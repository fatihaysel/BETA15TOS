...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flarum-likes', function () {
  flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.extensionData.for('flarum-likes').registerPermission({
    icon: 'far fa-thumbs-up',
    label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarum-likes.admin.permissions.like_posts_label'),
